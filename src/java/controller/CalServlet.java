...
public class CalServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            String x = request.getParameter("fisrt");
            String y = request.getParameter("second");
            String z = request.getParameter("operator");
            //transe String to double
            double a = Double.parseDouble(x);
            double b = Double.parseDouble(y);
            double rs = 0;

            if (x.equals(null) || y.equals(null) || z == null) {
            ...
            request.setAttribute("fisrt", a);
                request.setAttribute("second", b);
                request.setAttribute("operator", z);
